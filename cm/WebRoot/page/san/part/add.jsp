                    ...
                    <div class="widget widget-info">
                        ...
                        <div class="widget-body">
                            <form id="defaultForm" method="post" action="/{$Think.MODULE_NAME}/{$Think.CONTROLLER_NAME}/save" class="form-horizontal bv-form">
                                <fieldset>
                                    <legend>{$pageInfo.actionTitle}部门</legend><input type="hidden" name="action" value="{$pageInfo.action}"/><input type="hidden" name="id" value="{$part.id}"/>
