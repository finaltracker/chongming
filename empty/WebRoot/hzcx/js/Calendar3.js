...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	this.beginYear = beginYear || 1990;//起点——年
	this.endYear   = endYear   || 2050;//结束——年
	...
	this.colors = {"bg_cur_day":"#0078ff","bg_over":"#f4f4f4","bg_out":"#f9cb15"}//选中，背景，经过 代码
};
...
__ci.document.writeln('table {border:0px solid #CCCCCC;background-color:#FFFFFF;}');//年、月
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#FFFFFF;}');//周一至周五
__ci.document.writeln('th.theader {font-weight:normal;background-color:#0060cd;color:#FFFFFF;width:24px;}')//星期一——日代码//;
__ci.document.writeln('select.year {width:64px;}');//年
__ci.document.writeln('select.month {width:60px;}');//月
__ci.document.writeln('td {font-size:12px;text-align:center;}');
__ci.document.writeln('td.sat {color:#0000FF;background-color:#EFEFEF;}');//六
__ci.document.writeln('td.sun {color:#FF0000;background-color:#EFEFEF;}');//日
__ci.document.writeln('td.normal {background-color:#EFEFEF;}');
__ci.document.writeln('input.l {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;}');//清除
__ci.document.writeln('input.r {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:20px;height:20px;}');//今天
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;}');//关闭
__ci.document.writeln('-->');
