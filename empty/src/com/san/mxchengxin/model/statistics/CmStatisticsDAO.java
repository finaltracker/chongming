package com.san.mxchengxin.model.statistics;
// default package
...
public class CmStatisticsDAO extends HibernateDaoSupport  {
    ...
    public void update(CmStatistics transientInstance) {
		log.debug("updating CmStatistics instance");
		try {
    ...
    public CmStatistics findById( java.lang.Integer id) {
        ...
        try {
            CmStatistics instance = (CmStatistics) getHibernateTemplate()
                    .get("com.san.mxchengxin.model.statistics.CmStatistics", id);
            return instance;
        } catch (RuntimeException re) {
