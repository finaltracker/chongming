...
values (55,24,37,-10,'admin',1468938372,1,1468938372,13);
insert into CM_RECORD (ID,PERSON_ID,TARGET_ID,SCORE,AUTHOR,PUBDATE,STAT,DATELINE,PART_ID) 
values (56,18,38,-100,'admin',1468938387,1,1468938387,13);
insert into CM_RECORD (ID,PERSON_ID,TARGET_ID,SCORE,AUTHOR,PUBDATE,STAT,DATELINE,PART_ID) 
values (57,24,35,-100,'admin',1468938514,1,1468938514,13);
insert into CM_RECORD (ID,PERSON_ID,TARGET_ID,SCORE,AUTHOR,PUBDATE,STAT,DATELINE,PART_ID) 
values (59,35,28,-200,'admin',1468939105,1,2332939105,23);
commit;
